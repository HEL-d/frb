...
namespace FirstGearGames.LobbyAndWorld.Lobbies.JoinCreateRoomCanvases
{
    ...
    public class CreateRoomMenu : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        private TMP_InputField avatarurltext;
        /// <summary>
      ...
      //   public string rpmname = "ava";
    //    public string rpurl = "https://models.readyplayer.me/63b148828596abea61087323.glb";
       ...
       public void OnClick_CreateRoom()
        {
            if (_awaitingCreateResponse)
                return;
             string rnmae = string.Empty;
              string url = string.Empty;
               
           // string purl = getavatarurl(url);
            string roomName = _nameText.text;
            string password = _passwordText.text;
            int playerCount = ConvertPlayerCount(_playerCount.captionText.text);
            string avatarurl = avatarurltext.text;
            ...
            else
            {
                ...
                LobbyNetwork.AddUsername(avatarurl);
            }
        }
