...
namespace FirstGearGames.LobbyAndWorld.Lobbies.JoinCreateRoomCanvases
{
    ...
    public class JoinCreateRoomCanvas : MonoBehaviour
    {
        ...
        [SerializeField]
        private quitapp _qapp;

        public quitapp quitapp { get { return _qapp; } }
